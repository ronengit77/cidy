...
function Infer-TopicAreas {
    ...
    if ($text -match "programme_operations|programme operations|cidy-pd-operations|operational records|active projects|ongoing projects|current projects|2026 proposals|proposals|requests|activities|targeted ldcs|targeting ldcs|activity counts|project list") { $areas.Add("programme_operations") }
